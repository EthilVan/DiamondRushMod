...
public class GuiMainMenu extends GuiScreen
{
    ...
    {
        this.controlList.add(new GuiButton(2, this.width / 2 - 100, par1, par3StringTranslate.translateKey("Connexion au DiamondRush")));
    }
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        {
            this.mc.displayGuiScreen(new GuiConnecting(mc, "play.ethilvan.fr", 1337));
        }
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        GL11.glPopMatrix();
        String var9 = "Minecraft 1.4.5 for DR";
